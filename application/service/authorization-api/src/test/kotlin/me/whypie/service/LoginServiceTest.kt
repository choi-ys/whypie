...
internal class LoginServiceTest {
    ...
    fun login() {
        ...
        given(authorizationService.issue(Principal.mapTo(member.email, member.mapToSimpleGrantedAuthority())))
        ...
        verify(authorizationService, times(1)).issue(Principal.mapTo(member.email, member.mapToSimpleGrantedAuthority()))
    }
}